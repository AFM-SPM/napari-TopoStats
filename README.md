...
There is also a run button in that window. This runs the function on the selected layer (it does exactly th
same thing as clicking the function button in the grid).
