...
Activate your Python environment and make sure your Python version is >= 3.10 and < 3.12. An example
environment command would be:
...
Alternatively, to ensure the latest version is installed (this branch), with [Git installed] on your machine,
you can install the napari-TopoStats package from GitHub using [pip][pip].

    pip install git+https://github.com/AFM-SPM/napari-TopoStats.git@ahobbs7/adjusting_curves
...
<img src="src/napari_topostats/guide_images/loading_files.gif" width="800" alt="Input channel window"/>

The channel can be changed later after the image has been loaded.

<img src="src/napari_topostats/guide_images/changing_channel.gif" width="800" alt="Change channel docked widget"/>

Contrast limits, colour scale and other image options are adjustable in the left pannel.

<img src="src/napari_topostats/guide_images/generic_image_options.gif" width="800" alt="Image options">

Topostats tools can be accessed from the toolbar of napari (top left) as shown.

<img src="src/napari_topostats/guide_images/loading_plugin.gif" width="800" alt="Loading plugin from toolbar"/>
...
<img src="src/napari_topostats/guide_images/running_filters.gif" width="800" alt="Running filters"/>
...
<img src="src/napari_topostats/guide_images/running_grains.gif" width="800" alt="Running grains">
...
<img src="src/napari_topostats/guide_images/loading_config.gif" width="800" alt="Loading a config file"/>
...
<img src="src/napari_topostats/guide_images/edit_config.gif" width="800" alt="Edit config window"/>
...
<img src="src/napari_topostats/guide_images/making_3d.gif" width="800" alt="Make 3D function"/>
...
<img src="src/napari_topostats/guide_images/3d_controls.gif" width="800" alt="3D controls in the bottom left"/>
...
<img src="src/napari_topostats/guide_images/grainstats.gif" width="800" alt="Running grainstats"/>
...
<img src="src/napari_topostats/guide_images/batch_process.gif" width="800" alt="Function window"/>
...
<img src="src/napari_topostats/guide_images/viewing_curves.gif" width="800" alt="Viewing curves"/>
...
<img src="src/napari_topostats/guide_images/adjusting_curve_viewing.gif" width="800" alt="Adjusting curve viewing"/>
...
<img src="src/napari_topostats/guide_images/profile_line_drawing.gif" width="800" alt="Line profile drawing"/>
...
<img src="src/napari_topostats/guide_images/profile_line_scaling.gif" width="800" alt="Line profile scaling"/>
